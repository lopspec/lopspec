...
class JUnitFormatter extends BasicFormatter
{
    ...
    public function afterExample(ExampleEvent $event)
    {
        ...
        if (in_array($event->getResult(),
            [ExampleEvent::BROKEN, ExampleEvent::FAILED])) {
    ...
    /** @type array */
    protected $exampleStatusCounts = [];
    /** @type array */
    protected $jUnitStatuses
        = [
    ...
    /** @type array */
    protected $testCaseNodes = [];
    /** @type array */
    protected $testSuiteNodes = [];
}
