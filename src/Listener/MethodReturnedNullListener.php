...
class MethodReturnedNullListener implements EventSubscriberInterface
{
        ...
        foreach ($this->nullMethods as $methodString => $failedCall) {
            ...
            if ($this->io->askConfirmation($message)) {
                $this->generator->generate(
                    ...
                    ['method' => $failedCall['method'], 'expected' => $expected]
                );
    ...
    /**
     * @type \LopSpec\CodeGenerator\GeneratorManager
     */
    private $generator;
    /**
    ...
    private $nullMethods = [];
    /**
     * @type \LopSpec\Locator\ResourceManager
     */
    private $resources;
}
