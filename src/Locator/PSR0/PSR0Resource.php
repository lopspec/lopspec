 ...
 */
namespace LopSpec\Locator\PSR0;
...
class PSR0Resource implements ResourceInterface
{
    ...
    {
        return $this->locator->getSpecNamespace() . implode('\\', $this->parts)
               . 'Spec';
    }
    /**
     * @return string
    ...
    public function getSpecFilename()
    {
        ...
        return $this->locator->getFullSpecPath() . implode(DIRECTORY_SEPARATOR,
            $parts) . 'Spec.php';
    }
    /**
     * @return string
    ...
    public function getSpecNamespace()
    {
        ...
        return rtrim($this->locator->getSpecNamespace() . implode('\\',
                $nsParts), '\\');
    }
    /**
     * @return string
    ...
    public function getSrcFilename()
    {
        ...
        return $this->locator->getFullSrcPath() . implode(DIRECTORY_SEPARATOR,
            $parts) . '.php';
    }
    /**
     * @return string
    ...
    public function getSrcNamespace()
    {
        ...
        return rtrim($this->locator->getSrcNamespace() . implode('\\',
                $nsParts), '\\');
    }
    /**
     * @type PSR0Locator
