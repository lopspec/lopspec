...
use LopSpec\Wrapper\SubjectContainerInterface;
use LopSpec\Wrapper\WrapperInterface;
 ...
 * @method \LopSpec\Wrapper\Subject\Expectation\DuringCall shouldThrow($exception = null)
 */
                                ...
                                SpecificationInterface
{
    ...
    {
        return call_user_func_array([$this->object, '__invoke'],
            func_get_args());
    }
    /**
    ...
    /**
     * Used by { @link LopSpec\Runner\Maintainer\SubjectMaintainer::prepare() }
