...
use LopSpec\Exception\Fracture\InterfaceNotImplementedException;
...
class SubjectWithArrayAccess
{
    ...
    {
        return new SubjectException(sprintf('Can not use %s as array.',
     ...
     * @throws \LopSpec\Exception\Fracture\InterfaceNotImplementedException
     */
