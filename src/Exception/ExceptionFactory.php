...
class ExceptionFactory
{
    ...
    {
        return new SubjectException(sprintf('Call to a member function %s on a non-object.',
    ...
    {
        $message = sprintf('Class %s does not exist.',
            $this->presenter->presentString($classname));
    ...
    {
        return new SubjectException(sprintf('Getting property %s on a non-object.',
     ...
     */
    public function methodNotFound($classname, $method, array $arguments = [])
    {
     ...
     */
    public function methodNotVisible($classname, $method, array $arguments = [])
    {
        $instantiator = new Instantiator();
        $subject = $instantiator->instantiate($classname);
     ...
     */
    public function namedConstructorNotFound(
        $classname,
        $method,
        array $arguments = []
    )
    {
        ...
        return new Fracture\NamedConstructorNotFoundException($message,
