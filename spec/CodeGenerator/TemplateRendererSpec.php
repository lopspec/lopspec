...
class TemplateRendererSpec extends ObjectBehavior
{
    ...
    function it_has_locations_setter()
    {
        ...
        $this->getLocations()
             ->shouldReturn(['location1', 'location2']);
    }
    ...
    function it_provides_a_method_to_append_location()
    {
        ...
        $this->getLocations()
             ->shouldReturn(['location1', 'location2', 'location0']);
    }
    function it_provides_a_method_to_prepend_location()
    {
        ...
        $this->getLocations()
             ->shouldReturn(['location0', 'location1', 'location2']);
    }
    ...
    {
        $fs->pathExists('location1' . DIRECTORY_SEPARATOR . 'some_file.tpl')
           ->willReturn(true);
        $fs->getFileContents('location1' . DIRECTORY_SEPARATOR
                             . 'some_file.tpl')
           ->willReturn('cont');
        $this->setLocations(['location1']);
        $this->render('some_file')
             ->shouldReturn('cont');
    }
