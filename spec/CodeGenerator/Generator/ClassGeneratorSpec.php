...
class ClassGeneratorSpec extends ObjectBehavior
{
    function it_asks_confirmation_if_class_already_exists(
        ...
        $resource->getSrcFilename()
                 ->willReturn('/project/src/Acme/App.php');
        $resource->getSrcNamespace()
                 ->willReturn('Acme');
        $resource->getSrcClassname()
                 ->willReturn('Acme\App');
        $fs->pathExists('/project/src/Acme/App.php')
           ->willReturn(true);
    ...
    function it_creates_folder_for_class_if_needed(
        $io,
        $tpl,
        $fs,
        ResourceInterface $resource
        ...
        $fs->pathExists('/project/src/Acme/App.php')
           ->willReturn(false);
        $fs->isDirectory('/project/src/Acme')
           ->willReturn(false);
        $fs->makeDirectory('/project/src/Acme')
           ->shouldBeCalled();
