...
class ServiceContainerSpec extends ObjectBehavior
{
    ...
    function it_provides_a_way_to_remove_service_by_key($service)
    {
        ...
        $this->shouldThrow()
             ->duringGet('collection1.some_service');
        $this->getByPrefix('collection1')
             ->shouldHaveCount(0);
    }
