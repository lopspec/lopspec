...
**lopspec** wraps some of the objects used in specs. For example ``$this``
is the object you are describing wrapped in a lopspec object. This is how
...
Then this will not work as expected because **lopspec** will intercept the
